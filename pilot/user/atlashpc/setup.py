...
def get_asetup(asetup=True, alrb=False):
    ...
    msg = 'user - atlashpc asetup: {} alrb: {}'.format(str(asetup), str(alrb))
    logger.debug(msg)
    ...
    msg = 'user - atlashpc return value: {}'.format(str(cmd))
    logger.debug(msg)
...
def get_asetup_options(release, homepackage):
    ...
    if 'AnalysisTransforms' in homepackage:
        ...
        _homepackage = re.sub(r'^AnalysisTransforms-*', '', homepackage)
