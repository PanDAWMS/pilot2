...
REVISION = '20'  # revision number should be reset to '0' for every new version release, increased for small updates
BUILD = '1e'   # build number should be reset to '1' for every new development cycle
