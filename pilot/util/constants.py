...
VERSION = '5'   # version number is '1' for first real Pilot 2 release, '0' until then, increased for bigger updates
REVISION = '5'  # revision number should be reset to '0' for every new version release, increased for small updates
BUILD = '16c'   # build number should be reset to '1' for every new development cycle
