...
REVISION = '14'  # revision number should be reset to '0' for every new version release, increased for small updates
BUILD = '2g'   # build number should be reset to '1' for every new development cycle
